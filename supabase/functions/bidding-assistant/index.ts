...
4. 标注每个章节对应的评分分值
5. 建议可关联的知识库模板
6. material_checklist中每项材料名称必须精确具体，不要笼统描述。例如：不要写"资质证书"，而要分别列出"CMMI L5级证书"、"ISO 27001认证证书"、"ISO 9001认证证书"等。每项资质/证书/证明都必须单独列为一条记录，便于逐项上传对应材料
  ...
  "material_checklist": [
    {
      ...
      "material_name": "需要上传的具体材料名称（务必精确到证书/资质全称，如：CMMI L5级证书、ISO 27001信息安全管理体系认证证书、ISO 9001质量管理体系认证证书、营业执照副本、社保缴纳证明等）",
      "material_format": "扫描件PDF|原件照片|复印件盖章|电子证书",
